...
public interface IAdapterListener {
     ...
     */
    void processed(Subscription subscription, StatusType statusType);
     ...
     *            The resulting {@link StatusType}.
     * @param exception
     *            exception wich occured
     */
    void processed(Subscription subscription, StatusType statusType, Exception exception);
}
