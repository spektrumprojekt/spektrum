 ...
 * 
 */
public class DiscussionMentionFeatureCommand implements
    ...
    public Feature getFeatureId() {
        return Feature.DISCUSSION_MENTION_FEATURE;
    }
    ...
    public void process(UserSpecificMessageFeatureContext context) {
        ...
        if (!context.check(Feature.DISCUSSION_ROOT_FEATURE, 1)
            ...
            if (relation != null
                ...
                Map<String, Message> messages = context.getMessagesOfRelation();
