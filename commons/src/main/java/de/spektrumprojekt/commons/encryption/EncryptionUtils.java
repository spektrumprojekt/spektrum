...
package de.spektrumprojekt.commons.encryption;
...
public class EncryptionUtils {
    ...
    /**
     * specifies the key for the encryption password, stored in spektrum.properties
     */
    public static final String PASSWORD_ENCRYPTION_KEY = "spektrum.encryption.key";
    ...
    public static String decrypt(String encryptedText)
            throws EncryptionException {
        return decrypt(encryptedText, loadKey());
    }
    ...
    public static String decrypt(String encryptedText, String password)
        ...
        try {
            ...
            byte[] encryptedTextAsByte = Base64Utils.decode(StringUtils
                    .substringBeforeLast(encryptedText, SEPARATOR));
            ...
            throw new EncryptionException(
                    "The encryption algorithm was not found", e);
    ...
    public static String encrypt(String clearText) throws EncryptionException {
        ...
        return encrypt(clearText, loadKey(), generateSalt());
    }
    ...
    public static String encrypt(String clearText, String password, byte[] salt)
        ...
        try {
            ...
            byte[] inputAsByte;
            try {
                inputAsByte = clearText.getBytes("UTF-8");
        ...
        return Base64Utils.encode(encryptedBytes) + SEPARATOR
                + Base64Utils.encode(salt);
    }
    ...
    private static SecretKey getSecretKey(String password, byte[] salt)
        ...
        KeySpec spec = new PBEKeySpec(password.toCharArray(), salt, rounds,
                keyLength);
    ...
    /**
     * loads the key specified in spektrum.properties
     * 
     * @return
     */
    private static String loadKey() {
        String key = SpektrumConfiguration.INSTANCE.getProperties()
                .getProperty(PASSWORD_ENCRYPTION_KEY, "default");
        // if (key == null) {
        // throw new RuntimeException(
        // "Please provide a key for passwordencryption.");
        // }
        return key;
    }
