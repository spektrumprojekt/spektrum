package de.spektrumprojekt.i.evaluation.runner.specificranker;
...
/**
 * Daniel Lemire A simple implementation of the weighted slope one algorithm in Java for item-based
 * collaborative filtering. Assumes Java 1.5.
 * 
...
public class SlopeOne {
    ...
    public static void main(String args[]) {
        ...
        SlopeOne.print(so.predict(user4));
    ...
    /**
     * Based on existing data, and using weights, try to predict all missing ratings. The trick to
     * make this more scalable is to consider only mDiffMatrix entries having a large (>1)
     * mFreqMatrix entry.
     * 
    ...
    /**
     * Based on existing data, and not using weights, try to predict all missing ratings. The trick
     * to make this more scalable is to consider only mDiffMatrix entries having a large (>1)
     * mFreqMatrix entry.
     */
