...
public class EvaluationExecuter implements EvaluationExecutionProvider {
    ...
    private void evalSingleMessage(Message spektrumMessage) throws InterruptedException, Exception {
        ...
        chain.afterRankingMessage(spektrumMessage, context);
    ...
    private void setupIntelligence() throws Exception {
        ...
        if (executionConfiguration.isUseIterativeCollabRanker()) {
            ...
            CollaborativeIntelligenceFactory collaborativeIntelligenceFactory = new CollaborativeIntelligenceFactory(
                    ...
                    false);
            scorer = collaborativeIntelligenceFactory.getRanker();
            ...
            if (executionConfiguration.getSpecialRankCommandClass() != null) {
                ...
                if (executionConfiguration.getSpecialRankCommandClass().equals(
                        RandomRankerCommand.class)) {
                    command = new RandomRankerCommand(
                        ...
                        RelevantRankerCommand.class)) {
                    command = new RelevantRankerCommand();
                } else {
                    throw new IllegalArgumentException("Unknown command clazz"
                            + executionConfiguration.getSpecialRankCommandClass());
                }

                scorer = new SpecialRanker<Command<UserSpecificMessageFeatureContext>>(persistence,
                        communicator,
                        memberRunner,
    ...
    private void storeMessageRanksInFile() throws Exception {
        this.persistence.visitAllMessageRanks(new MessageRankVisitor() {
